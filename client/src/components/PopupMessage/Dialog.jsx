...
const PopupMessage = ({ open, title, message, onClose }) => {
  return (
    <Dialog open={open} onClose={onClose} PaperProps={{ className: classes.dialogWrapper }} data-testid="popup-wrap">
      ...
      <button type="button" onClick={onClose} className={classes.button} data-testid="button-close">
